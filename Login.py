...
import sys
# Variable global para almacenar el usuario actual después del inicio de sesión
usuario_actual = None
flag = 1
# Función para verificar el login
def verificar_login():
    global usuario_actual, index_opened
...
# Etiquetas y entradas para el código y la contraseña
